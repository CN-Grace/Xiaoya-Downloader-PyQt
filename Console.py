...
def login(username: str, password: str) -> str:
    pre_login_url = """
https://infra.ai-augmented.com/api/auth/cas/login?school_certify=10511&client_id=xy_client_ccnu&state=09wvt1&redirect_uri=https://ccnu.ai-augmented.com/api/jw-starcmooc/user/authorCallback&response_type=code&week_no_login_status=0&scope=&next=https%3A%2F%2Finfra.ai-augmented.com%2Fapp%2Fauth%2Foauth2%2FsecurityNotice%3Fresponse_type%3Dcode%26state%3D09wvt1%26client_id%3Dxy_client_ccnu%26redirect_uri%3Dhttps%3A%2F%2Fccnu.ai-augmented.com%2Fapi%2Fjw-starcmooc%2Fuser%2FauthorCallback%26school%3D10511%26lang%3Dzh_CN&back=https%3A%2F%2Finfra.ai-augmented.com%2Fapp%2Fauth%2Foauth2%2Flogin%3Fresponse_type%3Dcode%26state%3D09wvt1%26client_id%3Dxy_client_ccnu%26redirect_uri%3Dhttps%3A%2F%2Fccnu.ai-augmented.com%2Fapi%2Fjw-starcmooc%2Fuser%2FauthorCallback%26school%3D10511%26lang%3Dzh_CN
    """
    login_url = "https://account.ccnu.edu.cn/cas/login?service=https%3A%2F%2Finfra.ai-augmented.com%2Fapi%2Fauth%2Fcas%2Flogin%3Fschool_certify%3D10511"
    dialog = requests.session()
    dialog.headers = {
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.0.0 Safari/537.36 Edg/117.0.2045.47"
    }
    dialog.get(url=pre_login_url)
    ...
    if dialog.cookies.get("HS-prd-access-token") is None:
        print("登录失败")
        sleep(5)
        exit()
    print("登录成功")
...
def get_json(url: str, headers: dict) -> bool or dict:
    try:
